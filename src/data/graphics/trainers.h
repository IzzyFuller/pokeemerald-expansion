...
const u32 gTrainerFrontPic_Enby[] = INCBIN_U32("graphics/trainers/front_pics/enby.4bpp.smol");
const u16 gTrainerPalette_Enby[] = INCBIN_U16("graphics/trainers/palettes/enby.gbapal");
...
const u8 gTrainerBackPic_Enby[] = INCBIN_U8("graphics/trainers/back_pics/enby.4bpp");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_ENBY, gTrainerFrontPic_Enby, gTrainerPalette_Enby),
};
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_ENBY, 4, gTrainerBackPic_Enby, gTrainerPalette_Enby, sBackAnims_Hoenn),
};
